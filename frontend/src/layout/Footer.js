...
const FollowIcon = () => (
  ...
  Courses = () => (
    <Fragment>
      <li>
        <Link href="/course-details">Fase 1</Link>
      </li>
      <li>
        <Link href="/course-details">Fase 2</Link>
      </li>
      <li>
        <Link href="/course-details">Fase 3</Link>
      </li>
      <li>
        <Link href="/course-details">Taller de Evangelismo</Link>
      </li>
    </Fragment>
  ),
  Resources = () => (
    <Fragment>
      <li>
        <Link href="/contact">Videos</Link>
      </li>
      <li>
        <Link href="/contact">Talleres</Link>
      </li>
      <li>
        <Link href="/contact">Material de apoyo</Link>
      </li>
      <li>
        <Link href="/contact">Esstudios bíblicos</Link>
      </li>
    </Fragment>
  ),
  FooterBottom = () => (
  ...
  CopyRight = () => (
    <p>
      © {new Date().getFullYear()}. <Link href="/">CCG</Link> All rights
      reserved.
    </p>
  ),
        ...
        <div className="row justify-content-between text-white pt-75">
          ...
          <div className="col-lg-2 col-md-3 col-sm-4">
            <div className="footer-widget menu-widget">
              <h5 className="footer-title">Cursos</h5>
              <ul>
                <Courses />
              </ul>
            </div>
            ...
            <div className="row">
              <div className="col-sm-6">
                <div className="footer-widget contact-info-widget">
                  ...
                  <ul>
                    <li>
                      <i className="fas fa-map-marker-alt" /> Dirección: Av. Francisco de Orellana
                    </li>
                    {/* <li>
                    ...
                    <li>
                      ...
                      <a href="callto:+0123456789">098 456 2344</a>
                    </li>
                    <li>
                      <i className="far fa-clock" /> Cultos - Domingos
                      <br /> 8:00 - 9:30 
                      <br /> 10:00 - 11:30 
                      <br /> 12:00 - 13:30
